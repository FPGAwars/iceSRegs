{
  ...
  "package": {
    "name": "04-SR-imp1",
    "version": "0.5",
    "description": "04-SR-imp1: 4-bits Shift register to the right.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "2b506459-0db5-4f5c-8afa-4631abf83682",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "5093a3bd-4572-4416-a74a-b21fd22166b3",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "ce0a396b-e0c3-4b8d-b1df-301f402bf7ee",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "7653c2ae-01a0-4b62-9409-93b706e99d77",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
        ...
        {
          "id": "5b7140f2-d4f6-41e8-9626-df14a91cdb8e",
        ...
        {
          "id": "c62acbfa-774e-40e6-8009-3aeddd0ec5cf",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "5b7140f2-d4f6-41e8-9626-df14a91cdb8e",
        ...
        },
        {
          ...
          "target": {
            "block": "c62acbfa-774e-40e6-8009-3aeddd0ec5cf",
        ...
        },
        {
          ...
          "target": {
            "block": "2b506459-0db5-4f5c-8afa-4631abf83682",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "ce0a396b-e0c3-4b8d-b1df-301f402bf7ee",
            "port": "outlabel"
          },
          "target": {
            "block": "7653c2ae-01a0-4b62-9409-93b706e99d77",
            "port": "in",
            "size": 4
          },
          "size": 4
        ...
        {
          "source": {
            "block": "5093a3bd-4572-4416-a74a-b21fd22166b3",
            "port": "outlabel"
          },
          "target": {
            "block": "5b7140f2-d4f6-41e8-9626-df14a91cdb8e",
