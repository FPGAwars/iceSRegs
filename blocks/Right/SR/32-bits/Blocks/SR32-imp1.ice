{
  ...
  "package": {
    "name": "SR-32-imp1",
    "version": "0.4",
    "description": "SR-32-imp1: 32-bits Shift register to the right.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "21cdf1b5-9748-41b7-aeec-52f9a31e9225",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "5abe8b9f-ceda-4f92-a8f4-b18074d778f5",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "410c683d-2aac-44c2-89b9-7260efd97861",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[31:0]",
        ...
        {
          "id": "b3b3e805-1464-4502-ab98-95859d873f08",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "92bd039d-b464-4595-850a-9212ef6270eb",
        ...
        {
          "id": "dcab995b-c1aa-44d0-9a1b-225b150c1764",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "dcab995b-c1aa-44d0-9a1b-225b150c1764",
        ...
        },
        {
          ...
          "target": {
            "block": "92bd039d-b464-4595-850a-9212ef6270eb",
        ...
        {
          "source": {
            "block": "b3b3e805-1464-4502-ab98-95859d873f08",
            "port": "outlabel"
          },
          "target": {
            "block": "410c683d-2aac-44c2-89b9-7260efd97861",
            "port": "in",
            "size": 32
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "21cdf1b5-9748-41b7-aeec-52f9a31e9225",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "5abe8b9f-ceda-4f92-a8f4-b18074d778f5",
            "port": "outlabel"
          },
          "target": {
            "block": "dcab995b-c1aa-44d0-9a1b-225b150c1764",
