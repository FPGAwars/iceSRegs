{
  "version": "1.2",
  "package": {
    "name": "04-Sys-SR-ld-imp1",
    "version": "0.5",
    "description": "04-Sys-SR-ld-imp1: 4-bits System Shift register to the right, with load. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "d18a20e6-4bf8-4523-8e1a-8ac56ab4d3da",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "470fa8dc-0dcc-4d6a-a98f-fb976ca008c6",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "22f64f4e-8538-42f4-961d-23419e0086b4",
          "type": "basic.outputLabel",
          "data": {
            "name": "sdata",
            "range": "[3:0]",
        ...
        {
          "id": "470d098e-ae46-4625-b09d-a18bb2463e85",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "b5e82911-d910-45c9-bfc0-5d01a3e3cfd8",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
        ...
        {
          "id": "f5ac9575-3b38-45f4-961a-dacd400e62df",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "cce3b36b-204f-4d5f-b627-395cdc4222b7",
          "type": "basic.input",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "96c83b72-8032-47e6-8e21-ec4ee5f212bd",
          "type": "basic.inputLabel",
          "data": {
            "name": "sdata",
            "range": "[3:0]",
        ...
        {
          "id": "443310e9-459e-4db2-ae57-3ceae3eb5393",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "67e3827a-4da0-4884-a7eb-c5c7edb02859",
        ...
        {
          "id": "6be6ca59-eb45-4168-bf13-e4ddcd930254",
        ...
        {
          "id": "7f8a9acd-ee6a-42dd-b21d-452dc04ee41b",
      ...
      "wires": [
        {
          "source": {
            "block": "6be6ca59-eb45-4168-bf13-e4ddcd930254",
        ...
        },
        {
          ...
          "target": {
            "block": "67e3827a-4da0-4884-a7eb-c5c7edb02859",
        ...
        },
        {
          ...
          "target": {
            "block": "7f8a9acd-ee6a-42dd-b21d-452dc04ee41b",
        ...
        },
        {
          ...
          "target": {
            "block": "470fa8dc-0dcc-4d6a-a98f-fb976ca008c6",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "470d098e-ae46-4625-b09d-a18bb2463e85",
            "port": "outlabel"
          },
          "target": {
            "block": "b5e82911-d910-45c9-bfc0-5d01a3e3cfd8",
            "port": "in",
            "size": 4
          },
          "size": 4
        ...
        {
          "source": {
            "block": "d18a20e6-4bf8-4523-8e1a-8ac56ab4d3da",
            "port": "outlabel"
          },
          "target": {
            "block": "67e3827a-4da0-4884-a7eb-c5c7edb02859",
        ...
        {
          "source": {
            "block": "22f64f4e-8538-42f4-961d-23419e0086b4",
            "port": "outlabel"
          },
          "target": {
            "block": "67e3827a-4da0-4884-a7eb-c5c7edb02859",
        ...
        {
          "source": {
            "block": "cce3b36b-204f-4d5f-b627-395cdc4222b7",
            "port": "out",
            "size": 4
          },
          "target": {
            "block": "f5ac9575-3b38-45f4-961a-dacd400e62df",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "96c83b72-8032-47e6-8e21-ec4ee5f212bd",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "443310e9-459e-4db2-ae57-3ceae3eb5393",
            "port": "outlabel"
          },
          "target": {
            "block": "6be6ca59-eb45-4168-bf13-e4ddcd930254",
