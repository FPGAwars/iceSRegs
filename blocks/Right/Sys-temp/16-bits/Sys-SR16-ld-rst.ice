{
  "version": "1.2",
  "package": {
    "name": "Sys-SR16-ld-rst-verilog",
    "version": "0.4",
    "description": "Sys-SR16-ld-rst-verilog: 16-bits System Shift register to the right, with load. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "b823c4e1-329a-41f8-bcd5-6eee362ae846",
          "type": "basic.inputLabel",
          "data": {
            "name": "q",
            "range": "[15:0]",
        ...
        {
          "id": "12079a41-5f05-4c28-8e05-f84d07be1563",
          "type": "basic.outputLabel",
          "data": {
            "name": "q",
            "range": "[15:0]",
        ...
        {
          "id": "8fe5a4eb-41bf-404d-84cd-4588a0e82c68",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "9b1f9991-6f02-43fc-9d31-d35e9b32294d",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        {
          "id": "c2600133-b11e-4d48-baf0-733bf5b8958c",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        {
          "id": "8e93ce62-d693-4302-a43f-60f8b0de057f",
          "type": "basic.input",
          "data": {
            "name": "d",
            "virtual": true,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b823c4e1-329a-41f8-bcd5-6eee362ae846",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          "source": {
            "block": "12079a41-5f05-4c28-8e05-f84d07be1563",
            "port": "outlabel"
          },
          "target": {
            "block": "8fe5a4eb-41bf-404d-84cd-4588a0e82c68",
            "port": "in",
            "size": 16
          },
          "size": 16
        ...
        {
          "source": {
            "block": "9b1f9991-6f02-43fc-9d31-d35e9b32294d",
            "port": "outlabel"
          },
          "target": {
            "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
        ...
        {
          "source": {
            "block": "8e93ce62-d693-4302-a43f-60f8b0de057f",
            "port": "out",
            "size": 16
          },
          "target": {
            "block": "c2600133-b11e-4d48-baf0-733bf5b8958c",
            "port": "inlabel"
          },
          "size": 16
        },
