{
  "version": "1.2",
  "package": {
    "name": "16-Sys-SR-ld-rst-imp1",
    "version": "0.4",
    "description": "16-Sys-SR-ld-rst-imp1: 16-bits System Shift register to the right, with load and reset. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "cbc86de3-bdde-48e3-a1a3-4108297ce01a",
          "type": "basic.output",
          "data": {
            "name": "nc"
          },
        ...
        {
          "id": "e599d7d0-cfdf-4558-9ded-2355e98eb122",
          "type": "basic.outputLabel",
          "data": {
            "name": "rst",
            "blockColor": "red"
        ...
        {
          "id": "e34a0c74-0b1a-49d9-af59-f1963476ab4d",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        {
          "id": "1ff68dfb-a21d-407e-8c1d-5f2cee99a287",
          "type": "basic.input",
          "data": {
            "name": "rst",
            "clock": false
        ...
        {
          "id": "b9ec357c-6bf3-4809-8467-6f182cf822fa",
          "type": "basic.inputLabel",
          "data": {
            "name": "rst",
            "blockColor": "red"
        ...
        {
          "id": "beafd1fc-d7be-4673-a69a-d4613e19c73a",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[15:0]",
        ...
        {
          "id": "aa055044-573f-478a-9ad1-953314fe505d",
          "type": "basic.outputLabel",
          "data": {
            "name": "sdata",
            "range": "[15:0]",
        ...
        {
          "id": "ff11fa23-5cac-494d-aa35-e7af7c1b06d1",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[15:0]",
        ...
        {
          "id": "4d261508-8d86-45e3-ba93-77074dd152e9",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[15:0]",
        ...
        {
          "id": "f465649e-193e-4e61-adb1-bb70b81716b3",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        {
          "id": "109ee37c-6e47-4970-bf0c-9043d39d5246",
          "type": "basic.input",
          "data": {
            "name": "d",
            "range": "[15:0]",
        ...
        {
          "id": "dd7e61c0-da0f-46e9-889f-3df9b5a7a04e",
          "type": "basic.inputLabel",
          "data": {
            "name": "sdata",
            "range": "[15:0]",
        ...
        {
          "id": "f456530c-f23b-43ad-ba83-62e532c29ddb",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[15:0]",
        ...
        {
          "id": "12ceb351-0926-4232-a6d1-32550a0d91ed",
        ...
        {
          "id": "82a68535-6256-482e-87de-c1fa998a912c",
        ...
        {
          "id": "2fe4d5b2-5dae-43ed-938e-e7289e300f43",
      ...
      "wires": [
        {
          "source": {
            "block": "82a68535-6256-482e-87de-c1fa998a912c",
        ...
        },
        {
          ...
          "target": {
            "block": "12ceb351-0926-4232-a6d1-32550a0d91ed",
        ...
        },
        {
          ...
          "target": {
            "block": "2fe4d5b2-5dae-43ed-938e-e7289e300f43",
        ...
        {
          "source": {
            "block": "1ff68dfb-a21d-407e-8c1d-5f2cee99a287",
            "port": "out"
          },
          "target": {
            "block": "b9ec357c-6bf3-4809-8467-6f182cf822fa",
            "port": "inlabel"
          }
        },
        {
          "source": {
            "block": "e599d7d0-cfdf-4558-9ded-2355e98eb122",
            "port": "outlabel"
          },
          "target": {
            "block": "2fe4d5b2-5dae-43ed-938e-e7289e300f43",
        ...
        {
          "source": {
            "block": "4d261508-8d86-45e3-ba93-77074dd152e9",
            "port": "outlabel"
          },
          "target": {
            "block": "ff11fa23-5cac-494d-aa35-e7af7c1b06d1",
            "port": "in",
            "size": 16
          },
          "size": 16
        },
        {
          ...
          "target": {
            "block": "beafd1fc-d7be-4673-a69a-d4613e19c73a",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          "source": {
            "block": "e34a0c74-0b1a-49d9-af59-f1963476ab4d",
            "port": "outlabel"
          },
          "target": {
            "block": "12ceb351-0926-4232-a6d1-32550a0d91ed",
        ...
        {
          "source": {
            "block": "aa055044-573f-478a-9ad1-953314fe505d",
            "port": "outlabel"
          },
          "target": {
            "block": "12ceb351-0926-4232-a6d1-32550a0d91ed",
        ...
        },
        {
          ...
          "target": {
            "block": "dd7e61c0-da0f-46e9-889f-3df9b5a7a04e",
            "port": "inlabel"
          },
          "size": 16
        },
        {
          "source": {
            "block": "f456530c-f23b-43ad-ba83-62e532c29ddb",
            "port": "outlabel"
          },
          "target": {
            "block": "82a68535-6256-482e-87de-c1fa998a912c",
        ...
        {
          "source": {
            "block": "109ee37c-6e47-4970-bf0c-9043d39d5246",
            "port": "out",
            "size": 16
          },
          "target": {
            "block": "f465649e-193e-4e61-adb1-bb70b81716b3",
            "port": "inlabel"
          },
          "size": 16
        },
