{
  "version": "1.2",
  "package": {
    "name": "02-Sys-SR-ld-rst-imp1",
    "version": "0.5",
    "description": "02-Sys-SR-ld-rst-imp1: 2-bits System Shift register to the right, with load and reset. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "60486d9a-cd90-43f8-8a9d-61ab9fc184b8",
          "type": "basic.output",
          "data": {
            "name": "nc"
          },
        ...
        {
          "id": "dd0fa976-36c5-4eb4-b721-d7a33a0cb25e",
      ...
      "wires": [
        {
          "source": {
            "block": "dd0fa976-36c5-4eb4-b721-d7a33a0cb25e",
