{
  "version": "1.2",
  "package": {
    "name": "04-Sys-SR4-ld-rst-imp1",
    "version": "0.4",
    "description": "04-Sys-SR-ld-rst-imp1: 4-bits System Shift register to the right, with load and reset. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "b7d99157-d934-4945-ba24-e13ff9990932",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "af5f6bdb-35bc-4c9b-9096-eb5b2c524646",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "bd985264-9ea5-46d2-a05a-24fb48d5951b",
          "type": "basic.outputLabel",
          "data": {
            "name": "sdata",
            "range": "[3:0]",
        ...
        {
          "id": "4ed9b376-09a1-490c-9764-17fe0e6a47a7",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
        ...
        {
          "id": "c2fcc0c1-c782-4646-8152-08de70c85174",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "68806461-38e3-40dc-b609-108e404019de",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "01be8a6f-79a6-42cd-94e3-eca879a92342",
          "type": "basic.input",
          "data": {
            "name": "d",
            "range": "[3:0]",
        ...
        {
          "id": "e4828bd3-aacf-4003-8ede-2af9b412fec0",
          "type": "basic.inputLabel",
          "data": {
            "name": "sdata",
            "range": "[3:0]",
        ...
        {
          "id": "09d4ad73-a169-4ac6-ab87-7e421debfee1",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "6ed9efd9-70ed-4cf3-af8c-6b9f4af27119",
        ...
        {
          "id": "0576315a-1314-432e-b0d9-860775913d61",
        ...
        {
          "id": "26d2e88a-b2ba-4392-8926-43b1590c81c0",
      ...
      "wires": [
        {
          "source": {
            "block": "0576315a-1314-432e-b0d9-860775913d61",
        ...
        },
        {
          ...
          "target": {
            "block": "6ed9efd9-70ed-4cf3-af8c-6b9f4af27119",
        ...
        },
        {
          ...
          "target": {
            "block": "26d2e88a-b2ba-4392-8926-43b1590c81c0",
        ...
        {
          "source": {
            "block": "c2fcc0c1-c782-4646-8152-08de70c85174",
            "port": "outlabel"
          },
          "target": {
            "block": "4ed9b376-09a1-490c-9764-17fe0e6a47a7",
            "port": "in",
            "size": 4
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "af5f6bdb-35bc-4c9b-9096-eb5b2c524646",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "b7d99157-d934-4945-ba24-e13ff9990932",
            "port": "outlabel"
          },
          "target": {
            "block": "6ed9efd9-70ed-4cf3-af8c-6b9f4af27119",
        ...
        {
          "source": {
            "block": "bd985264-9ea5-46d2-a05a-24fb48d5951b",
            "port": "outlabel"
          },
          "target": {
            "block": "6ed9efd9-70ed-4cf3-af8c-6b9f4af27119",
        ...
        },
        {
          ...
          "target": {
            "block": "e4828bd3-aacf-4003-8ede-2af9b412fec0",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "09d4ad73-a169-4ac6-ab87-7e421debfee1",
            "port": "outlabel"
          },
          "target": {
            "block": "0576315a-1314-432e-b0d9-860775913d61",
        ...
        {
          "source": {
            "block": "01be8a6f-79a6-42cd-94e3-eca879a92342",
            "port": "out",
            "size": 4
          },
          "target": {
            "block": "68806461-38e3-40dc-b609-108e404019de",
            "port": "inlabel"
          },
          "size": 4
        },
