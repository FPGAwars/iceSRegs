{
  "version": "1.2",
  "package": {
    "name": "Sys-SR-rst-08-imp1",
    "version": "0.5",
    "description": "Sys-SR-rst-08-imp2: 8-bits System Shift register to the right, with reset.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a24f5ed6-761a-49ca-b87a-3df9a85bb18f",
          "type": "basic.output",
          "data": {
            "name": "nc"
          },
        ...
        {
          "id": "08b9eeae-83e8-4c97-b655-646ca56fd441",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[7:0]",
        ...
        {
          "id": "bf64af8b-0a33-4bc6-bded-3842b2edafd2",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[7:0]",
        ...
        {
          "id": "399a7e81-aaba-400a-a97e-8696f2d250d8",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[7:0]",
        ...
        {
          "id": "dd26d99b-73b5-457e-8fa6-2d754d1afd36",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[7:0]",
        ...
        {
          "id": "ba397e07-459f-4424-892c-771818bf29eb",
          "type": "basic.input",
          "data": {
            "name": "nc",
            "virtual": true,
        ...
        {
          "id": "f1029dc3-6938-4402-9bd0-d3fa35e3a36a",
        ...
        {
          "id": "728e19d7-7f83-4331-af28-a991552db864",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "728e19d7-7f83-4331-af28-a991552db864",
        ...
        },
        {
          ...
          "target": {
            "block": "f1029dc3-6938-4402-9bd0-d3fa35e3a36a",
        ...
        },
        {
          ...
          "target": {
            "block": "08b9eeae-83e8-4c97-b655-646ca56fd441",
            "port": "inlabel"
          },
          "size": 8
        },
        {
          "source": {
            "block": "399a7e81-aaba-400a-a97e-8696f2d250d8",
            "port": "outlabel"
          },
          "target": {
            "block": "dd26d99b-73b5-457e-8fa6-2d754d1afd36",
            "port": "in",
            "size": 8
          },
          "size": 8
        ...
        {
          "source": {
            "block": "bf64af8b-0a33-4bc6-bded-3842b2edafd2",
            "port": "outlabel"
          },
          "target": {
            "block": "728e19d7-7f83-4331-af28-a991552db864",
