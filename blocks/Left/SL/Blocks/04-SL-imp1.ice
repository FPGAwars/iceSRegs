{
  ...
  "package": {
    "name": "04-SL-imp1",
    "version": "0.8",
    "description": "04-SL-imp1: 2 bits shift left register. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5aeb8134-e63d-45a4-9877-7bd28e1e7c6e",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "b9f372f1-dcb1-444c-9a1e-793ef176257c",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "9cfdadcf-64bf-4c47-9ffa-18d78afc8d64",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "8da8f118-7124-4b5d-8923-bbde106864df",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "5de53d73-bb05-42d5-a57e-2d0cfe832a4b",
        ...
        {
          "id": "ab28400a-fcee-4eae-9b07-bae245829a70",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "ab28400a-fcee-4eae-9b07-bae245829a70",
        ...
        },
        {
          ...
          "target": {
            "block": "5de53d73-bb05-42d5-a57e-2d0cfe832a4b",
        ...
        {
          "source": {
            "block": "b9f372f1-dcb1-444c-9a1e-793ef176257c",
            "port": "outlabel"
          },
          "target": {
            "block": "5aeb8134-e63d-45a4-9877-7bd28e1e7c6e",
            "port": "in",
            "size": 4
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "9cfdadcf-64bf-4c47-9ffa-18d78afc8d64",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "8da8f118-7124-4b5d-8923-bbde106864df",
            "port": "outlabel"
          },
          "target": {
            "block": "ab28400a-fcee-4eae-9b07-bae245829a70",
