{
  "version": "1.2",
  "package": {
    "name": "Sys-SL32-ld-verilog",
    "version": "0.4",
    "description": "Sys-SL32-ld-verilog: 32-bits System Shift register to the left, with load. Verilog implementation",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "335b7817-58ca-4039-9a8c-8bc27b6f59ae",
          "type": "basic.inputLabel",
          "data": {
            "name": "q",
            "range": "[31:0]",
        ...
        {
          "id": "8a32acb0-9144-46f0-a251-3c14fbfcb917",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "529e1381-4619-405f-8765-6f9368c93471",
          "type": "basic.outputLabel",
          "data": {
            "name": "q",
            "range": "[31:0]",
        ...
        {
          "id": "acf6854e-aab4-47db-9bbb-a40db4c248fb",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[31:0]",
        ...
        {
          "id": "c963bb8a-094a-4b66-b0f4-1610450fa454",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[31:0]",
        ...
        {
          "id": "a781174f-f600-4565-a540-1b27a0eb4559",
          "type": "basic.input",
          "data": {
            "name": "d",
            "virtual": true,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "529e1381-4619-405f-8765-6f9368c93471",
            "port": "outlabel"
          },
          "target": {
            "block": "8a32acb0-9144-46f0-a251-3c14fbfcb917",
            "port": "in",
            "size": 32
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "335b7817-58ca-4039-9a8c-8bc27b6f59ae",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "acf6854e-aab4-47db-9bbb-a40db4c248fb",
            "port": "outlabel"
          },
          "target": {
            "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
        ...
        {
          "source": {
            "block": "a781174f-f600-4565-a540-1b27a0eb4559",
            "port": "out",
            "size": 32
          },
          "target": {
            "block": "c963bb8a-094a-4b66-b0f4-1610450fa454",
            "port": "inlabel"
          },
          "size": 32
        },
