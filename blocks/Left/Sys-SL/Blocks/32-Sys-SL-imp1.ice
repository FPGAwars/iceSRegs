{
  ...
  "package": {
    "name": "32-Sys-SL-imp1",
    "version": "0.6",
    "description": "32-Sys-SL-imp1: 32-bits System Shift register to the left.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c37d16f1-341f-4400-b9ea-b9b7f0ca0f76",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "1bd52cb4-84e6-49cb-9501-e9503a7f3cdd",
        ...
        {
          "id": "4d6f1847-20c7-45d3-b32c-719cf9eb49f1",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[31:0]",
        ...
        {
          "id": "34a3f74d-2fd0-494d-abfa-c4185850a94f",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "43e5e05f-18ac-42f2-a128-112682f8aaf1",
        ...
        {
          "id": "9ad3abaa-2e5b-4c4c-81ea-f0da2cecba69",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "43e5e05f-18ac-42f2-a128-112682f8aaf1",
        ...
        {
          "source": {
            "block": "34a3f74d-2fd0-494d-abfa-c4185850a94f",
            "port": "outlabel"
          },
          "target": {
            "block": "4d6f1847-20c7-45d3-b32c-719cf9eb49f1",
            "port": "in",
            "size": 32
          },
          "size": 32
        ...
        {
          "source": {
            "block": "9ad3abaa-2e5b-4c4c-81ea-f0da2cecba69",
            "port": "adfb2cfe-8521-4f06-ac72-3d200ba84185",
            "size": 32
          },
          "target": {
            "block": "c37d16f1-341f-4400-b9ea-b9b7f0ca0f76",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "1bd52cb4-84e6-49cb-9501-e9503a7f3cdd",
            "port": "outlabel"
          },
          "target": {
            "block": "43e5e05f-18ac-42f2-a128-112682f8aaf1",
