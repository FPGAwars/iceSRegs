{
  ...
  "package": {
    "name": "Sys-SL-08-imp1",
    "version": "0.5",
    "description": "Sys-SL-08-imp1: 8-bits System Shift register to the left.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f90dd34f-0673-484d-9a22-30bf4f5de63c",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[7:0]",
        ...
        {
          "id": "089b3d13-550f-48cf-a19c-2ec22fc20302",
        ...
        {
          "id": "029a8698-5b6d-4c35-a466-1b3abc635adc",
          "type": "basic.output",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "872a53c0-36f7-4d0d-b1a3-9dd0bb019c94",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[7:0]",
        ...
        {
          "id": "44346acb-6121-4410-91c0-2815a2925a1f",
        ...
        {
          "id": "374f17e7-79f2-4054-b6e3-fc82c48a2230",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "44346acb-6121-4410-91c0-2815a2925a1f",
        ...
        {
          "source": {
            "block": "872a53c0-36f7-4d0d-b1a3-9dd0bb019c94",
            "port": "outlabel"
          },
          "target": {
            "block": "029a8698-5b6d-4c35-a466-1b3abc635adc",
            "port": "in",
            "size": 8
          },
          "size": 8
        ...
        {
          "source": {
            "block": "089b3d13-550f-48cf-a19c-2ec22fc20302",
            "port": "outlabel"
          },
          "target": {
            "block": "44346acb-6121-4410-91c0-2815a2925a1f",
        ...
        {
          "source": {
            "block": "374f17e7-79f2-4054-b6e3-fc82c48a2230",
            "port": "f2f0f3eb-8a53-4e50-adc2-eead9e2420cf",
            "size": 8
          },
          "target": {
            "block": "f90dd34f-0673-484d-9a22-30bf4f5de63c",
            "port": "inlabel"
          },
          "size": 8
        },
