{
  "version": "1.2",
  "package": {
    "name": "Sys-SL8-ld-rst-imp1",
    "version": "0.4",
    "description": "Sys-SL8-ld-rst-imp1: 8-bits System Shift register to the left, with load and reset. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "520139ff-f132-4bd5-91df-609b13f3ecd1",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "520139ff-f132-4bd5-91df-609b13f3ecd1",
