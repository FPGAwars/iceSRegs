{
  "version": "1.2",
  "package": {
    "name": "32-Sys-SL-rst-imp1",
    "version": "0.6",
    "description": "32-Sys-SL-rst-imp1: 32-bits System Shift register to the left, with reset.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "814a5b77-258d-4583-b684-c28332d97458",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "72185b54-f899-45c8-9e94-1e152215dddd",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "82c2e79e-d5ab-4453-9b27-0334d53b4ce9",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[31:0]",
        ...
        {
          "id": "ec72ce11-7585-48cd-99ac-16570e4fe7e5",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "9e5535e7-3175-4d2e-b4ae-f5ebc01bab1f",
        ...
        {
          "id": "76d0482e-4e13-47a8-9134-33458c6a1db2",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "76d0482e-4e13-47a8-9134-33458c6a1db2",
        ...
        {
          "source": {
            "block": "9e5535e7-3175-4d2e-b4ae-f5ebc01bab1f",
        ...
        {
          "source": {
            "block": "ec72ce11-7585-48cd-99ac-16570e4fe7e5",
            "port": "outlabel"
          },
          "target": {
            "block": "82c2e79e-d5ab-4453-9b27-0334d53b4ce9",
            "port": "in",
            "size": 32
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "814a5b77-258d-4583-b684-c28332d97458",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "72185b54-f899-45c8-9e94-1e152215dddd",
            "port": "outlabel"
          },
          "target": {
            "block": "9e5535e7-3175-4d2e-b4ae-f5ebc01bab1f",
