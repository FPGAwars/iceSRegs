{
  "version": "1.2",
  "package": {
    "name": "04-Sys-SL-rst-imp1 CLONE",
    "version": "0.6",
    "description": "Sys-SL-rst-04-imp1: 4-bits System Shift register to the left, with reset.  Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "3c819c36-c323-4377-94c9-88c4c3db4a38",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "fa75bb6f-c9c1-436e-a55e-ba9ff599ad36",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "fcba79e6-fb6f-47cd-9a85-2d3accc4764e",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[3:0]",
        ...
        {
          "id": "7a89aa8b-18ea-406d-9f1a-2387c4bf32ef",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[3:0]",
        ...
        {
          "id": "fa8b8285-f250-4632-803f-e00db2cfe620",
        ...
        {
          "id": "dd4662e3-04aa-4fef-ac00-287fbe612afa",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "dd4662e3-04aa-4fef-ac00-287fbe612afa",
        ...
        {
          "source": {
            "block": "fa8b8285-f250-4632-803f-e00db2cfe620",
        ...
        {
          "source": {
            "block": "7a89aa8b-18ea-406d-9f1a-2387c4bf32ef",
            "port": "outlabel"
          },
          "target": {
            "block": "fcba79e6-fb6f-47cd-9a85-2d3accc4764e",
            "port": "in",
            "size": 4
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "3c819c36-c323-4377-94c9-88c4c3db4a38",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "fa75bb6f-c9c1-436e-a55e-ba9ff599ad36",
            "port": "outlabel"
          },
          "target": {
            "block": "fa8b8285-f250-4632-803f-e00db2cfe620",
