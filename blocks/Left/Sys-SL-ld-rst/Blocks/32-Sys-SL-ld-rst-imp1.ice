{
  "version": "1.2",
  "package": {
    "name": "32-Sys-SL-ld-rst-imp1",
    "version": "0.5",
    "description": "32-Sys-SL-ld-rst-imp1: 32-bits System Shift register to the left, with load and reset. Block implementation 1",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "fbf46458-1ae5-41f1-98b4-682df3efe771",
          "type": "basic.outputLabel",
          "data": {
            "name": "d",
            "range": "[31:0]",
        ...
        {
          "id": "f021a8cd-72a0-4473-a12a-20825186c760",
          "type": "basic.inputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "4992a0a8-edb9-4faf-8d39-aab3aba8f936",
          "type": "basic.outputLabel",
          "data": {
            "name": "sdata",
            "range": "[31:0]",
        ...
        {
          "id": "f48d8c95-a24d-4645-9dd1-e0b546c49fa4",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[31:0]",
        ...
        {
          "id": "c82a6825-cb58-4318-9554-3c7a7dc2ab8a",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "197309fe-7e62-4ed6-a7f4-8278ad220a5b",
          "type": "basic.inputLabel",
          "data": {
            "name": "d",
            "range": "[31:0]",
        ...
        {
          "id": "5cb0ffba-dbd1-4c17-9f12-1a24441404d6",
          "type": "basic.input",
          "data": {
            "name": "d",
            "range": "[31:0]",
        ...
        {
          "id": "0d46a934-997f-4b92-9458-72d7ff3a9b76",
          "type": "basic.inputLabel",
          "data": {
            "name": "sdata",
            "range": "[31:0]",
        ...
        {
          "id": "6f3282c7-6198-4172-ab65-86809cf30ec9",
          "type": "basic.outputLabel",
          "data": {
            "name": "next",
            "range": "[31:0]",
        ...
        {
          "id": "f145269c-2383-4f9f-b57a-0053f966329d",
        ...
        {
          "id": "1b2328cb-d981-4971-8f5b-4d9af6c73af3",
          "type": "9f1efb238eeb87131aff3b010b25d16d377677c9",
          "position": {
            "x": 544,
            "y": 1312
          },
        ...
        {
          "id": "37510b1d-cb5a-4549-b435-3ffad5192e0d",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "f145269c-2383-4f9f-b57a-0053f966329d",
        ...
        {
          "source": {
            "block": "1b2328cb-d981-4971-8f5b-4d9af6c73af3",
        ...
        },
        {
          ...
          "target": {
            "block": "37510b1d-cb5a-4549-b435-3ffad5192e0d",
        ...
        {
          "source": {
            "block": "c82a6825-cb58-4318-9554-3c7a7dc2ab8a",
            "port": "outlabel"
          },
          "target": {
            "block": "f48d8c95-a24d-4645-9dd1-e0b546c49fa4",
            "port": "in",
            "size": 32
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "f021a8cd-72a0-4473-a12a-20825186c760",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "fbf46458-1ae5-41f1-98b4-682df3efe771",
            "port": "outlabel"
          },
          "target": {
            "block": "f145269c-2383-4f9f-b57a-0053f966329d",
        ...
        {
          "source": {
            "block": "4992a0a8-edb9-4faf-8d39-aab3aba8f936",
            "port": "outlabel"
          },
          "target": {
            "block": "f145269c-2383-4f9f-b57a-0053f966329d",
        ...
        },
        {
          ...
          "target": {
            "block": "0d46a934-997f-4b92-9458-72d7ff3a9b76",
            "port": "inlabel"
          },
          "size": 32
        },
        {
          "source": {
            "block": "6f3282c7-6198-4172-ab65-86809cf30ec9",
            "port": "outlabel"
          },
          "target": {
            "block": "1b2328cb-d981-4971-8f5b-4d9af6c73af3",
        ...
        {
          "source": {
            "block": "5cb0ffba-dbd1-4c17-9f12-1a24441404d6",
            "port": "out",
            "size": 32
          },
          "target": {
            "block": "197309fe-7e62-4ed6-a7f4-8278ad220a5b",
            "port": "inlabel"
          },
          "size": 32
        },
  ...
  "dependencies": {
    ...
    "9f1efb238eeb87131aff3b010b25d16d377677c9": {
      "package": {
