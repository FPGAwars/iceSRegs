...
def test(po):
    ...
    for bits in range(2,33):
        ...
        cad_match = f"""\
msgid ""
"{bits:02}-Sys-SR-rst: {bits} bits system shift right register with reset. Verilog "
"implementation"\
"""
...
"""  
        ...
        cad_target = f"""\
{cad_match}
msgstr "{bits:02}-Sys-SR-rst: Registro de desplazamiento a la derecha con reset. "
"Implementación en Verilog"
"""
        print(cad_match)
